...
export const updateOrder = (id, order) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `https://arfmart.onrender.com/api/v1/admin/order/${id}`,
      order,
      config
    );
...
export const deleteOrder = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`https://arfmart.onrender.com/api/v1/admin/order/${id}`);
...
export const getOrderDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://arfmart.onrender.com/api/v1/order/${id}`);
